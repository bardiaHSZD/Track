...
class ApplicationTracker:
    ...
    def save_data(self):
        ...
        for app, details in self.applications.items():
            active_time_seconds = self.convert_time_to_seconds(data[self.username][today][app]["active_time"]) + details["active_time"]
            idle_time_seconds = self.convert_time_to_seconds(data[self.username][today][app]["idle_time"]) + details["idle_time"]

            data[self.username][today][app]["active_time"] = self.seconds_to_hhmmss(ceil(active_time_seconds))
            data[self.username][today][app]["idle_time"] = self.seconds_to_hhmmss(ceil(idle_time_seconds))
